...
import numpy as np
from alexnet import AlexNet, fc
import random
import math
...
parser.add_argument("--unseen_word2vec", default="./data/word2vec/nus18_word2vec_50d.npy")
parser.add_argument("--seen_word2vec", default="./data/word2vec/pascal17_word2vec_50d.npy")

parser.add_argument("--num_epochs", type=int, default=10, help="number of training epochs")
parser.add_argument("--batch_size", type=int, default=100, help="number of images in batch")
parser.add_argument("--hash_bits", type=int, default=24, help="number of hash bits")
...
parser.add_argument("--delen", type=int, default=50, help="feature length in shared space")
...
parser.add_argument("--output_dir", default='./models/mlzsh-48b-nus-unseen-50d-top3/', help="where to put output files")
parser.add_argument("--log", default='./log/mlzsh-48b-nus-unseen-top3-50d-log.txt')
parser.add_argument("--save_freq", type=int, default=5000, help="save model every save_freq steps, 0 to disable")
parser.add_argument("--weights_path", default='./bvlc_alexnet.npy',
...
if __name__ == '__main__':
    ...
    nb_labels_seen = args.nb_labels_seen  # 18
    nb_labels_unseen = args.nb_labels_unseen  # 17
    ...
    visual_fc1 = fc(hash_layer, args.hash_bits, args.delen, 'visual_fc1', relu=False)
    ...
    with tf.Session(config=config) as sess:
        ...
        for i_epoch in range(args.num_epochs):
            ...
            pred_train_unseen_y = np.zeros(shape=[train_unseen_y.shape[0], 35], dtype=np.float32)
            ...
            while end_inds < valid_seen_x.shape[0]:
                ...
                begin_inds = begin_inds + args.batch_size
                end_inds = end_inds + args.batch_size
            hashcode_seen_val[begin_inds:valid_unseen_x.shape[0], :] = sess.run(hash_layer,
