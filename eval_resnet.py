...
parser.add_argument("--checkpoint", default='models/models-resnet/resnet50-12b-nus-unseen-top3-300d', help="directory with checkpoint to resume training from or use for testing")
parser.add_argument("--model_name", default='resnet50-12b-nus-unseen-top3-300d', help="which model to be evaluated")
parser.add_argument("--img_dir", default="./dataset/NUS-WIDE/all_images/", help="directory of input images")
parser.add_argument("--img_file", default="./data/nus/query_imglst.txt", help="test image file")
parser.add_argument("--data_type", default="test", choices=["train", "test", "val"])
...
def evaluate():
    ...
    hash_layer = graph.get_tensor_by_name('fc8/xw_plus_b:0')
