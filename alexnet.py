...
class AlexNet(object):
    ...
    def __init__(self, x, keep_prob, num_bits, num_classes, skip_layer, weights_path):
    ...
    def create(self):
        ...
        self.fc8 = fc(self.dropout7, 4096, self.NUM_BITS, relu=False, name='fc8')

        self.softsign = tf.nn.softsign(self.fc8, name='softsign')
        self.hc = tf.nn.tanh(self.fc8,  name='hc')
...
def fc(x, num_in, num_out, name, relu=True):
    ...
    with tf.variable_scope(name) as scope:
        ...
        weights = tf.get_variable('weights', shape=[num_in, num_out], regularizer=regularizer,
                                  trainable=True)
